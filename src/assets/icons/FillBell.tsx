...
const FillBellSvg = (props: SVGProps<SVGSVGElement>) => {
  const { fill } = props
  return (
...
const FillBell = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
  <IconBase ref={ref} icon={<FillBellSvg />} {...props} />
))

FillBell.displayName = 'FillBell'
export { FillBell }
