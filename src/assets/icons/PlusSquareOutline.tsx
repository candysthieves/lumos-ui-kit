...
const PlusSquareOutlineSvg = (props: SVGProps<SVGSVGElement>) => {
  const { fill } = props
  return (
    <svg xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 24 24'} fill={'none'} {...props}>
      <g fill={fill} clipPath={'url(#plus-square-outline)'}>
        <path
          d={
      ...
      <defs>
        <clipPath id={'plus-square-outline'}>
...
const PlusSquareOutline = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
  <IconBase ref={ref} icon={<PlusSquareOutlineSvg />} {...props} />
))
