...
const PersonRemoveOutlineSvg = (props: SVGProps<SVGSVGElement>) => {
  const { fill } = props
  return (
    <svg xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 24 24'} fill={'none'} {...props}>
      <g fill={fill} clipPath={'url(#person-remove-outline)'}>
        <path
          d={
      ...
      <defs>
        <clipPath id={'person-remove-outline'}>
...
const PersonRemoveOutline = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
  <IconBase ref={ref} icon={<PersonRemoveOutlineSvg />} {...props} />
))
