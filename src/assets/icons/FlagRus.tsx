...
const FlagRusSvg = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 24 24'} fill={'none'} {...props}>
      <path fill={'url(#flag-rus-a)'} d={'M0 0h24v24H0z'} />
      <defs>
        <pattern id={'flag-rus-a'} width={1} height={1} patternContentUnits={'objectBoundingBox'}>
          <use xlinkHref={'#flag-rus-b'} transform={'scale(.0139)'} />
        </pattern>
        <image
          xlinkHref={
